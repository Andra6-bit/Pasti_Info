...
// ✅ FIX: Search & Filter diproses di PHP
...
<header class="hero">
    <div class="navbar">
        <div class="logo">
            <img src="Assets/logo.jpeg" alt="logo" class="logo-img"> Info
        </div>
    ...
    <div class="hero-content">
        ...
        <!-- ✅ FIX: Form GET untuk search & filter via PHP -->
...
<section class="section">
    <div class="card-grid" id="cardGrid">
        ...
        ?>
        <div class="card">
            <img src="Assets/<?php echo htmlspecialchars($row['image']); ?>" alt="<?php echo htmlspecialchars($row['title']); ?>">
            <div class="card-body">
                ...
                <button class="btn-detail" onclick="openDetail(
                    ...
                    'Assets/<?php echo addslashes($row['image']); ?>',
...
<div class="modal" id="detailModal">
    <div class="modal-content">
        ...
        <div class="organizer">
            <img src="Assets/logo.jpeg" alt="Organizer Logo">
            <div>
